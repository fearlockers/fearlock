...
const config = {
  ...
  production: {
    ...
    apiUrl: 'https://fearlock.pages.dev/api'
  },
  // 開発環境用の設定
  development: {
    supabaseUrl: 'https://tvdckgrexwhqrzszynjh.supabase.co',
...
// 環境に応じた設定を選択
const currentEnv = location.hostname.includes('pages.dev') || location.hostname.includes('github.io') ? 'production' : 'development'; 
